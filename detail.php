        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-dark" href="comingsoon.php">Shop</a>
        ...
        ?>
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="card-img-pro" src="img/<?php echo $productImage?>" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4"><?php echo $salePrice?></h3>
            ...
            <div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">Product Description</a>
                    </div>
